...
class script(object):
    ...
    START_TXT = (
        "<b>{E_STAR} Hello {{}},</b>\n"
        "<b>{E_ROCKET} I am <a href=https://t.me/{{}}>{{name}}</a></b>\n"
        "<i>Your Professional Restricted Content Saver Bot.</i>\n"
        "<blockquote>"
        "<b>{E_GREEN} System Status: Online</b>\n"
        "<b>{E_BOLT} Performance: 10x High-Speed Processing</b>\n"
        "<b>{E_LOCK} Security: End-to-End Encrypted</b>\n"
        "<b>{E_STATS} Uptime: 99.9% Guaranteed</b>"
        "</blockquote>\n"
        "<b>{E_ARROW} Select an Option Below to Get Started:</b>"
    ).format(
        E_STAR=E_STAR, E_ROCKET=E_ROCKET, E_GREEN=E_GREEN,
        E_BOLT=E_BOLT, E_LOCK=E_LOCK, E_STATS=E_STATS, E_ARROW=E_ARROW
    ...
    ABOUT_TXT = (
        f"<blockquote>{E_INFO} <b>About This Bot</b>\n\n"
        f"<b>╭────[ {E_SPARK} 𝐀𝐍𝐔𝐉 ]────⍟</b>\n"
        f"<b>├⍟ {E_ROCKET} Bot Name : <a href=http://t.me/save_restricted_content_ak_bot>Save Content</a></b>\n"
        f"<b>├⍟ {E_DEV} Developer : <a href=https://t.me/anujedits76>𝐀𝐍𝐔𝐉 𝐊𝐔𝐌𝐀𝐑</a></b>\n"
        f"<b>├⍟ {E_LINK} Library : <a href='https://docs.pyrogram.org/'>Pyrogram Async</a></b>\n"
        f"<b>├⍟ {E_BOLT} Language : <a href='https://www.python.org/'>Python 3.11+</a></b>\n"
        f"<b>├⍟ {E_GEAR} Database : <a href='https://www.mongodb.com/'>MongoDB Atlas Cluster</a></b>\n"
        f"<b>├⍟ {E_STAR} Hosting : Dedicated High-Speed VPS</b>\n"
        f"<b>╰───────────────⍟</b></blockquote>\n"
    )
    ...
    try:
        for msgid in range(fromID, toID + 1):
            ...
            if is_private_link:
                ...
                chat_target = datas[4] if is_batch else datas[3]
